...
- App display name / package id / F-Droid distribution target — same as DriveWell's or new?
- Default public signaling-relay hosting (who runs the convenience default instance).
